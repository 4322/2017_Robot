...
//    @DashboardInputField(field="Shooter R: ")
    ...
    public static double DRIVEBASE_AIM_P = .000975;
    @DashboardInputField(field="Drivebase Aim I: ")
    public static double DRIVEBASE_AIM_I = 0.000125;
    ...
    public static double DRIVEBASE_AIM_D = 0.0003275;
    // *********************************
    // ** DRIVEBASE DRIVING MAP VALUES **
    // *********************************
    @DashboardInputField(field="Drivebase Drive P: ")
    public static double DRIVEBASE_DRIVE_P = .0285;
    ...
    public static double DRIVEBASE_DRIVE_D = 0.0155;
