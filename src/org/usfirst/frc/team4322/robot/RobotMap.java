...
//    @DashboardInputField(field="Shooter R: ")
    ...
    public static double DRIVEBASE_AIM_P = .001175;
    @DashboardInputField(field="Drivebase Aim I: ")
    public static double DRIVEBASE_AIM_I = 0.0001;
    ...
    public static double DRIVEBASE_AIM_D = 0.000325;
    // *********************************
    // ** DRIVEBASE DRIVING MAP VALUES **
    // *********************************
    @DashboardInputField(field="Drivebase Drive P: ")
    public static double DRIVEBASE_DRIVE_P = .028125;
    ...
    public static double DRIVEBASE_DRIVE_D = 0.0175;
    ...
    public static double DRIVEBASE_NAVX_P = .0004175;
