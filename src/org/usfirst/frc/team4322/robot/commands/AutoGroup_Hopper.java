...
public class AutoGroup_Hopper extends CommandGroup
{
	public AutoGroup_Hopper()
	{
		...
		addSequential(new DriveBase_DriveDistance(-78,true,0.8,true,0.31)); //Drive a distance
		addSequential(new DriveBase_Turn(-90)); //Turn 90 degrees
		addSequential(new DriveBase_DriveDistance(-101,true,1,false,0.51)); //Drive up to hopper
