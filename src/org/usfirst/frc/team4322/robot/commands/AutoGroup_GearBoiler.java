...
public class AutoGroup_GearBoiler extends CommandGroup
{
    public AutoGroup_GearBoiler()
    {
        ...
        addSequential(new DriveBase_DriveDistance(90.5, true,0.6,true,0.31)); //Drive a certain distance
        addSequential(new DriveBase_FMSTurn(60)); //Turn 30 degrees
        addSequential(new DriveBase_DriveDistance(26, false,0.85,false)); //Drive up to peg
